...
public final class TimelineEntryGenerator {
    public static let shared = TimelineEntryGenerator()
    
    private let patternService: PatternService = .shared
    private var cancellables: [AnyCancellable] = []
    
    public func generate(for family: WidgetFamily, times: Int, staredOnly: Bool, completion: @escaping ([Entry]) -> Void) {
